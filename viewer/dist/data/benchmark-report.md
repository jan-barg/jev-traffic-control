...
See the project README for commands, assumptions and metric definitions; [validation evidence](validation.json), [paired results](summary.json) and [protocol](protocol.json) for machine-readable details. Raw requests, signal actions, SUMO trip logs and replays are retained locally under `results/raw/`.

[NYC Midtown South study record](https://zap.planning.nyc.gov/projects/2024M0142) · [SUMO trip metrics](https://sumo.dlr.de/docs/Simulation/Output/TripInfo.html) · [TypeSafe documentation](https://docs.typesafe.ai/)
