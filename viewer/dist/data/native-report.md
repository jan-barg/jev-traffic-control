...
See [README](https://github.com/jan-barg/jev-traffic-control/tree/v1.0.0) for commands, assumptions and metric definitions; [validation evidence](validation.json), [paired results](summary.json) and [protocol](protocol.json) for machine-readable details. Raw requests, signal actions, SUMO trip logs and replays are retained locally under `results/raw/`.
